...
def cal_linear_decomposition_representation(passage_representation, passage_lengths, cosine_matrix,is_training, 
    ...
    with tf.variable_scope('lex_decomposition'):
        ...
        (lex_features_fw, lex_features_bw), _ = tf.nn.bidirectional_dynamic_rnn(
        ...
        for i in xrange(context_layer_num):
            with tf.variable_scope('layer-{}'.format(i)):
                with tf.variable_scope('context_represent'):
                    ...
                    (question_context_representation_fw, question_context_representation_bw), _ = tf.nn.bidirectional_dynamic_rnn(
                    ...
                    (passage_context_representation_fw, passage_context_representation_bw), _ = tf.nn.bidirectional_dynamic_rnn(
    ...
    with tf.variable_scope('aggregation_layer'):
        for i in xrange(aggregation_layer_num):
            with tf.variable_scope('layer-{}'.format(i)):
                ...
                cur_aggregation_representation, _ = tf.nn.bidirectional_dynamic_rnn(
